...
public class SwitchToggleTPV : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        if (ColorUtility.TryParseHtmlString(DataBasePersonalizacion.col_ppal_empl[0], out Color colorSec))
        {
    ...
    public void RefreshVisual()
    {
        ...
        {
            Debug.LogWarning($"[SwitchToggleTPV] uiHandleRectTransform no asignado en {gameObject.name} — no se puede refrescar el visual.", this);
            return;
        }
